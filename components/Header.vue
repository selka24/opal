<template>
    <div class="flex pt-14 justify-center relative">
        <div class="text-white text-[28px] font-bold uppercase absolute left-6 md:left-20 top-[48px]">
            OPAL .
        </div>
        ...
        <div class="max-w-max ml-auto text-white md:hidden block mr-6 md:mr-20">
            Hamburger
        </div>
    </div>
</template>
